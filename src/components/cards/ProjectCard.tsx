...
const ProjectCard = ({ project }: ProjectCardProps) => {
  ...
  return (
    <motion.div
      ...
      className="group relative h-full w-full rounded-xl bg-gray-900/40 border border-white/10 overflow-hidden transition-colors duration-500 hover:border-primary/50"
    >
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="px-6 pb-4 flex-1">
          <p className="text-gray-400 text-sm leading-relaxed mb-4 group-hover:text-gray-200 transition-colors line-clamp-3">
            {project.description}
          </p>
